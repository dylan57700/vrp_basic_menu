...
police_weapons = {}
police_weapons[lang.police_weapons.one] = {function(player,choice)
...
--medkit storage
emergency_medkit = {}
emergency_medkit[lang.emergency_medkit.one] = {function(player,choice)
...
--heal me
emergency_heal = {}
emergency_heal[lang.emergency_heal.one] = {function(player,choice)
	local user_id = vRP.getUserId(player) 
